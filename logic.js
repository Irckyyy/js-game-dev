...
// event listener to capture touch in thr screen and assign ther x and y coordinates in the startX and startY variable
document.addEventListener("touchstart", (e) =>{
	startX = e.touches[0].clientX;
	startY = e.touches[0].clientY;
})

//event listener to check where you touch the screen and prevent scrolling. Input targets any element that include the word tile.
